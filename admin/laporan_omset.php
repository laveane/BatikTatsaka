			...
			<form action="exp_omset.php" method="POST">
				<table>
					<tr>
						...
						<td><button type="submit" name="submit" class="btn btn-success"><i class="glyphicon glyphicon-save-file"></i>
	...
	<table class="table table-striped">
		...
		<?php
			...
			if(isset($_POST['submit'])){
				...
				$result = mysqli_query($conn, "SELECT * FROM produksi WHERE terima = 1");
			}
		...
		<tr>
			<td colspan="7" class="text-right alert-success"><b>Total Pendapatan = <?= number_format($total); ?></b>
			</td>
		</tr>
	</table>
</div>
