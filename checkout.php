...
<section class="checkout">
	<div class="container">
		<h4 class="title w-100 mb-5">Checkout</h4>
		<div class="row align-items-center">
			<div class="col-md-6">
				...
				?>
					<tr>
						<td colspan="6" style="text-align: right; font-weight: bold;">Grand Total =
		...
		<div class="row">
			<div class="col-md-6">
				<h5 class="bg-success text-white p-2">Pastikan pesanan Anda sudah benar</h5>
			</div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-6">
				<h5 class="bg-warning p-2">Isi form dibawah ini </h5>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				...
				curl_setopt_array($curl, array(
					...
					CURLOPT_HTTPHEADER     => array(
						...
						"key: 2ba0be6701c5fd580e010b9e2d1095cd"
					),
				));
						...
						<div class="col-md-6">
							<div class="form-group mb-3">
								...
								<input type="text" class="form-control" id="exampleInputPassword1"
									placeholder="Kode Pos" name="kopos">
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		$('#provinsi').change(function () {
			...
			$.ajax({
				type: 'GET',
				url: 'http://localhost/batik-production/cek_kabupaten.php',
				data: 'prov_id=' + prov,
		...
		$("#kurir").change(function () {
			...
			$.ajax({
				type: 'POST',
				url: 'http://localhost/batik-production/cek_ongkir.php',
				data: {
					'kab_id': kab,
					'kurir': kurir,
					'asal': asal,
